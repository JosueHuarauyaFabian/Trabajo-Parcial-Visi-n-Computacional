...
service = build('drive', 'v3', credentials=credentials)
  # Renderiza la plantilla HTML con el diseño y la interfaz de usuario mejorados
...
def upload():
    ...
    # Redirige al usuario a la página principal después de la carga
...
def list_files(category):
    ...
    # Renderiza la plantilla HTML con la lista de archivos y diseño mejorado
...
def get_file(category, file_id):
    ...
    try:
        ...
        fh.close()
        # Envía el archivo descargado al usuario con un diseño y experiencia de usuario mejorados
...
def download_all():
    ...
    # Envía el archivo zip descargado al usuario con un diseño y experiencia de usuario mejorados
